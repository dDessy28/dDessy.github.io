...
function preview() {
	var kepala = "<h2>" + apaAja('judul').value + "</h2><label>Penulis : " + apaAja('penulis').value + "</label><label style='margin-left:2em;'>Tanggal : " + apaAja('hari').value + "</label>";
	apaAja("preview").innerHTML = kepala + konten();
}
...
function konten() {
	...
	var konten = apaAja("konten").value;
	var kn = konten.replace(/\n\n|\n/g, "</p><p style='text-align:" + global + ";'>");
	var badan = "<p style='text-align:" + global + ";'>" + kn + "</p>";
	return badan;
}
